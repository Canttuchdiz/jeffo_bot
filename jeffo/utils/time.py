...
class FriendlyTimeResult:
    ...
    async def ensure_constraints(self, ctx: commands.Context, uft: UserFriendlyTime, now: datetime.datetime,
                                 remaining: str) -> None:
        if self.dt < now:
            raise commands.BadArgument('This time is in the past.')
...
class UserFriendlyTime(commands.Converter):
    ...
    async def convert(self, ctx: commands.Context, argument: str) -> FriendlyTimeResult:
